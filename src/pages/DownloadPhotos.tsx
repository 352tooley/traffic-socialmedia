    ...
    <Layout title="Download Photos" showBack>
      <div className="download-page">
        <div className="download-info">
          ...
          <p>
            Photos are saved locally to devices when mobile experts use the Upload feature.
            To collect photos, have mobile experts share their downloaded photos via your
          ...
          <div className="download-naming">
            ...
            <code>[StoreName]_[MobileExpert]_[Timestamp].jpg</code>
          </div>
        </div>
      </div>
    </Layout>
